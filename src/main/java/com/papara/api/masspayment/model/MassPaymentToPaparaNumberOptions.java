 ...
 * @since 0.0.1
 */
public class MassPaymentToPaparaNumberOptions extends PaparaModel {
     ...
     * It can be in the format 1234567890 or PL1234567890. Before the Papara version transition, the Papara number was called the wallet number.
    ...
    /**
     * Gets parse account number.
     * Parses the account number to long type.
     * In old papara integrations, account / wallet number was made by starting with PL.
     * The service was written in such a way that it accepts numbers starting with PL, in order not to cause problems to the member merchants that receive the papara number from their users.
     *
